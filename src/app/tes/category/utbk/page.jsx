...
export default function UTBK() {
    ...
    const fetchPopularTestsByCategory = async () => {
      try {
        const response = await fetch(
          `https://${URL}/dashboard/popular-tests-by-category?category=UTBK`
        );
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchBerbayarTestsByCategory = async () => {
      try {
        const response = await fetch(
          `https://${URL}/dashboard/locked-tests-by-category?category=UTBK`
        );
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchFreeTestsByCategory = async () => {
      try {
        const response = await fetch(
          `https://${URL}/dashboard/free-tests-by-category?category=UTBK`
        );
        if (!response.ok) {
  ...
  const handleSearch = debounce(async (query) => {
    ...
    try {
      const response = await fetch(
        `https://${URL}/dashboard/search-tests-by-category?title=${encodeURIComponent(
          searchQuery
        )}&category=UTBK`
      );
