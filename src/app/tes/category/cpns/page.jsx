...
export default function CPNS() {
  ...
  useEffect(() => {
    const fetchBerbayarTestsByCategory = async () => {
      try {
        const response = await fetch(`https://${URL}/dashboard/locked-tests-by-category?category=CPNS`);
        if (!response.ok) {
      ...
      <div className="flex justify-between items-center w-full">
        ...
        <div className="relative flex inline-block items-center ">
          <div className="mx-auto">
              {/* Judul besar */}
              <h5 className="text-sm lg:text-3xl font-bold font-bodoni mr-2 sm:mr-8">Latihan Soal Tes CPNS</h5>
