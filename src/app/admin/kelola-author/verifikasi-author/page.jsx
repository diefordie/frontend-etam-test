          ...
          <div className="flex flex-col lg:flex-row items-center justify-between px-2 md:px-7 lg:px-8 py-5 bg-white gap-4 font-poppins lg:pl-[380px] mt-[42px] md:mt-[50px] lg:mt-[60px]">
              ...
              <div className="flex gap-4 items-center font-poppins">
                <button
                  ...
                  className={`flex items-center text-[0.7rem]  lg:text-basic justify-between w-[92px] lg:w-[130px] px-4 py-2 text-black rounded-full ${filter === "semua" ? "bg-paleBlue" : "bg-abumuda"}`}
                >
                  <span>Semua</span>
                ...
                <button
                  ...
                  className={`flex items-center text-[0.7rem] lg:text-basic  justify-between  w-[98px]  lg:w-[130px] px-4 py-2 text-black rounded-full ${filter === "aktif" ? "bg-paleBlue" : "bg-abumuda"}`}
                >
                  <span>Disetujui</span>
                ...
                <button
                  ...
                  className={`flex items-center text-[0.7rem] lg:text-basic justify-between  w-[135px]  lg:w-[130px] px-4 py-2 text-black rounded-full ${filter === "nonaktif" ? "bg-paleBlue" : "bg-abumuda"}`}
                >
                        ...
                        <tr key={author.id}>
                          ...
                          <td className="border text-[0.5rem] lg:text-sm p-1 text-center align-middle">
                            ...
                            >
                              ...
                              <option value="Nonaktif">Tidak Disetujui</option>
                            </select>
                          </td>
                        </tr>
                      ))}
