          ...
          <div className="flex flex-col lg:flex-row items-center justify-between px-2 md:px-7 lg:px-8 py-5 bg-white gap-4 font-poppins lg:pl-[380px] mt-[42px] md:mt-[50px] lg:mt-[60px]">
            ...
            <div className="flex gap-4 items-center font-poppins">
              <button
                ...
                className={`flex items-center text-[0.7rem]  lg:text-basic justify-between w-[90px] lg:w-[130px] px-2 md:px-4 lg:px-4 py-2 md:py-2 lg:py-2 text-black rounded-full ${filter === "semua" ? "bg-paleBlue" : "bg-abumuda"}`}
              >
                <span>Semua</span> 
              ...
              <button
                ...
                className={`flex items-center text-[0.7rem] lg:text-basic  justify-between  w-[127px]  lg:w-[165px] px-2 md:px-4 py-2 text-black rounded-full ${filter === "belumVerifikasi" ? "bg-paleBlue" : "bg-abumuda"}`}
              > 
              ...
              <button
                ...
                className={`flex items-center text-[0.7rem] lg:text-basic  justify-between  w-[87px]  lg:w-[165px] px-2 md:px-4 py-2 text-black rounded-full ${filter === "sudahVerifikasi" ? "bg-paleBlue" : "bg-abumuda"}`}
                >
                < div className="flex gap-4 justify-between items-center ">
                  <span>Disetujui </span>
